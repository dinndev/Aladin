...
function About() {
  return (
    <div className="flex flex-col justify-between w-full sm:w-full h-1/3 md:w-6/12 items-center">
      <h1 className=" text-center me sm:text-5xl text-4xl">Hi, I'm Aladin</h1>
      <p className="text-center my-8 text-sm sm:text-lg description">
      ...
      <div className="flex w-full justify-center h-12 items-center">
        ...
        <button className="projects text-gray-500">Portfolio</button>
      </div>
    </div>
  );
}
